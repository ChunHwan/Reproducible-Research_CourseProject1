...
```
  ...
  Weektype_activity_Data <- data.frame(steps=activity_Data$steps,
                                       date=activity_Data$date, 
                                       interval=activity_Data$interval,
                                       weekday=weekdays(activity_Data$date),
                                       daytype=ifelse(Weektype_activity_Data$weekday == "saturday" | 
                                       Weektype_activity_Data$weekday == "sunday" | 
                                                      Weektype_activity_Data$weekday == "토요일" | 
                                       Weektype_activity_Data$weekday == "일요일",
                                       "weekend", "weekday"))

  ## Make divided histagrams for Weekend & Weekday
  Weektype_mean_data <- aggregate(Weektype_activity_Data$steps, 
                                  by=list(Weektype_activity_Data$daytype, 
                                  Weektype_activity_Data$weekday, 
                                  Weektype_activity_Data$interval), FUN=mean, na.rm=TRUE)
